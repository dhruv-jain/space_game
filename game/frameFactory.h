...
public:
  ...
  std::vector<Frame*> getLeftFrames(const std::string&);
...
private:
  ...
  std::map<std::string, std::vector<SDL_Surface*> > leftmultiSurfaces;
  ...
  std::map<std::string, std::vector<Frame*> > leftmultiFrames;
